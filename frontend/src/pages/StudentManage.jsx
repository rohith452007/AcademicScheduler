...
function StudentManage() {
    ...
    return (
        <div style={{ backgroundColor: "#f8fafc", minHeight: "100vh", fontFamily: "sans-serif", padding: 0, margin: 0 }}>
            {/* Header */}
            <header style={{
                ...
                <div>
                    <h1 style={{ fontSize: "28px", fontWeight: "900", color: "#2563eb", margin: 0, textTransform: "uppercase", letterSpacing: "-0.025em" }}>Student Core</h1>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "40px" }}>
                    ...
                    >
                        ...
                        <p style={{ color: "#dbeafe", fontSize: "16px", fontWeight: "500", opacity: 0.9, lineHeight: "1.6" }}>
                            Access your class schedule. Select your program, semester, and section to see your specific weekly timetable.
                        </p>
                ...
                <div style={{
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "24px" }}>
                        ...
                        <div>
                            ...
                            <p style={{ color: "#9ca3af", fontSize: "14px", fontWeight: "500", marginTop: "4px", margin: 0 }}>You are currently logged in with student permissions. Scheduling management is restricted to admins.</p>
                        </div>
                    </div>
                </div>
            </main>
